        ...
        <div id='navbar' className='navbar-collapse collapse'>
          <form ref='searchForm' className='navbar-form navbar-left animated' onSubmit={this.handleSubmit.bind(this)}>
            <div className='input-group'>
              <input type='text' className='form-control' placeholder={this.state.totalCharacters + ' filmes'} value={this.state.searchQuery} onChange={NavbarActions.updateSearchQuery} />
          ...
          <ul className='nav navbar-nav'>
            ...
            <li className='dropdown'>
              <a href='#' className='dropdown-toggle' data-toggle='dropdown'>Admin <span className='caret'></span></a>
              <ul className='dropdown-menu'>
                <li><Link to='/cinema'>Adicionar Cinema</Link></li>
                <li><Link to='/filme'>Adicionar Filme</Link></li>
              </ul>
            </li>
          </ul>
        </div>
