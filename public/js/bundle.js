...
var CinemasActions = function () {
    function CinemasActions() {
        ...
        this.generateActions('getCinemasSuccess', 'getCinemasFail');
    }
...
var AddFilme = function (_React$Component) {
  ...
  _createClass(AddFilme, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _AddFilmeStore2.default.listen(this.onChange);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _AddFilmeStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    value: function onChange(state) {
...
},{"../actions/AddFilmeActions":3,"../stores/AddFilmeStore":27,"./Cinemas":18,"react":"react","react-select":"react-select"}],15:[function(require,module,exports){
'use strict';
...
},{"../actions/CinemasActions":6,"../stores/CinemasStore":30,"react":"react","react-select":"react-select"}],19:[function(require,module,exports){
'use strict';
...
},{"./routes":24,"history/lib/createBrowserHistory":43,"react":"react","react-dom":"react-dom","react-router":"react-router"}],24:[function(require,module,exports){
'use strict';
...
var CinemasStore = function () {
  ...
  _createClass(CinemasStore, [{
    key: 'onGetCinemasSuccess',
    value: function onGetCinemasSuccess(data) {
      this.cinemas = data;
    }
  }]);
...
},{"_process":52,"warning":53}],41:[function(require,module,exports){
'use strict';
...
},{"./extractPath":48,"_process":52,"warning":53}],50:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":52,"warning":53}],51:[function(require,module,exports){
(function (process){
/**
